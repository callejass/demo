...
@Component({
  selector: 'app-edicion-medicinas',
  templateUrl: './edicionmedicinas.component.html',
  styleUrls: ['./edicionmedicinas.component.scss']
})
export class EdicionMedicinasComponent implements OnInit {
